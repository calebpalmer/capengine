...
public:
  ...
  void testDrawLine()
  {
    ...
    pixel = getPixelComponents(surface.get(), 8,
                               m_videoManager->toScreenCoord(surface.get(), 8));
    CPPUNIT_ASSERT(comparePixel(black, pixel));
  }
  ...
  void testGetPixel()
  {
    SurfacePtr surface = m_videoManager->loadSurfacePtr("data/pixel_test.png");
    ...
    pixel = getPixelComponents(
        surface.get(), 19, m_videoManager->toScreenCoord(surface.get(), 19));
    CPPUNIT_ASSERT(comparePixel(blue, pixel));

    pixel = getPixelComponents(surface.get(), 2,
                               m_videoManager->toScreenCoord(surface.get(), 2));
    CPPUNIT_ASSERT(comparePixel(black, pixel));

    pixel = getPixelComponents(surface.get(), 6,
                               m_videoManager->toScreenCoord(surface.get(), 6));
    CPPUNIT_ASSERT(comparePixel(black, pixel));

    pixel = getPixelComponents(surface.get(), 1,
                               m_videoManager->toScreenCoord(surface.get(), 1));
    CPPUNIT_ASSERT(comparePixel(white, pixel));

    pixel = getPixelComponents(surface.get(), 10,
                               m_videoManager->toScreenCoord(surface.get(), 3));
    CPPUNIT_ASSERT(comparePixel(white, pixel));
  }
