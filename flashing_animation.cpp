...
FlashingAnimation::FlashingAnimation(Uint32 windowID, int assetID, int width, int height, int x, int y,
				     int repeatCount, double intervalMS)
  : m_windowID(windowID), m_assetID(assetID), m_width(width), m_height(height), m_x(x), m_y(y),
    m_intervalMS(intervalMS), m_elapsedTimeMS(0.0), done(false)
{
