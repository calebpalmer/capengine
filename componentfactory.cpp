...
/** 
 ...
 \return 
   The component.
*/
std::unique_ptr<Component> ComponentFactory::makeComponent(const jsoncons::json &in_json){
	...
	throw ComponentCreationException(type, subtype, in_json, std::string("No factory method registered for layer type"));
}
...
/** 
 ...
 \param in_factoryFunction
   The function.
*/
void ComponentFactory::registerComponentType(const std::string &in_type, const std::string &in_subtype, factoryfunc_t in_factoryFunction){
