...
/**
 ...
 \return
   The component.
*/
std::unique_ptr<RigidBodyComponent>
    RigidBodyComponent::makeComponent(const jsoncons::json &in_json)
{
  try {
    ...
    throw ComponentCreationException(ComponentType::Physics, kType, in_json,
