...
Frame::Frame(CapEngine::Vector& locationIn, CapEngine::Vector& upIn, CapEngine::Vector& forwardIn) { 
...
Matrix* Frame::getMatrix(){
  ...
  unique_ptr<Matrix> translationMatrix(Matrix::createTranslationMatrix(location->getX(), location->getY(), location->getZ()));
