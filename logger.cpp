...
void Logger::log(const string &message, LogLevel level, char const *in_file,
                 int in_lineno)
{
...
/**
 ...
 \return
*/
void Logger::log(const std::exception &e, LogLevel level, char const *file,
                 int lineno)
{
...
/**
 ...
 \return
*/
void Logger::log(const jsoncons::json_exception &e, LogLevel level,
...
void Logger::setOutput(ostream &stream) { outputStream = &stream; }
