...
int Mouse::getx() const { return m_position.x; }

int Mouse::gety() const { return m_position.y; }

void Mouse::setx(int x) { m_position.x = x; }

void Mouse::sety(int y) { m_position.y = y; }
