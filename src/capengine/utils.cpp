                         ...
                         const SDL_Rect &containingRect)
{
  ...
  float containingAspectRatio = containingRect.h != 0
                                    ? static_cast<double>(containingRect.w) /
                                          static_cast<double>(containingRect.h)
                                    : 1.0;

  float srcAspectRatio = srcRect.h != 0 ? static_cast<double>(srcRect.w) /
                                              static_cast<double>(srcRect.h)
                                        : 1.0;
