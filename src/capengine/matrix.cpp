...
Matrix Matrix::createTranslationMatrix(double x, double y, double z)
{
  Vector vec1(1.0, 0.0, 0.0, 0.0);
  Vector vec2(0.0, 1.0, 0.0, 0.0);
  Vector vec3(0.0, 0.0, 1.0, 0.0);
...
Matrix Matrix::createScaleMatrix(double sx, double sy, double sz)
{
...
Matrix Matrix::createXRotationMatrix(double degrees)
{
...
Matrix Matrix::createYRotationMatrix(double degrees)
{
  double radAngle = DEGTORAD(degrees);
  double cosAngle = cos(radAngle);
  double sinAngle = sin(radAngle);
