...
/**
                \return The number of rows in the grid
*/
int GridLayout::getNumRows() const { return m_numRows; }

//! return the number of columns in the grid
/**
                \return The number of columns in the grid
*/
int GridLayout::getNumColumns() const { return m_numColumns; }
...
void GridLayout::updateChildren() { this->updateCellBoxes(); }
...
SDL_Rect GridLayout::getPosition() const { return m_position; }
