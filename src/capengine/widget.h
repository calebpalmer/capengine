...
public:
  ...
  virtual void setBorder(BorderStyle /*borderStyle*/,
...
/**
 \fn Widget::setBorder
 \brief Sets the border on a widget.  This is an optionally implemented virtual
 function. \param borderStyle \li The border style to use. \param \li The width
 of the border.
*/
