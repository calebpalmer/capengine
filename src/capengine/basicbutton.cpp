...
void BasicButton::update()
{
  ...
  // if the mouse button is pressed and it is on top of the button, update
  // button pressed flag
  ...
  // if mouse button is depressed and mouse is outside of the button, unset the
  // flag
...
void BasicButton::setEnabled(bool enabled) { m_enabled = enabled; }

bool BasicButton::isEnabled() const { return m_enabled; }

int BasicButton::getWidth() const { return m_width; }

int BasicButton::getHeight() const { return m_height; }

void BasicButton::setWidth(int width) { m_width = width; }

void BasicButton::setHeight(int height) { m_height = height; }

string BasicButton::getText() const { return m_text; }

void BasicButton::setText(const string text) { m_text = text; }
