...
int main(int argc, char* argv[])
{
    try {
        ...
        CapEngine::WindowParams windowParams{"flappypei",
                                             FlappyPei::kLogicalWindowWidth,
                                             FlappyPei::kLogicalWindowHeight,
                                             32,
                                             isFullScreen,
                                             false,
                                             true,
        ...
        auto mainGameState = std::make_shared<FlappyPei::MainGameState>(windowId);
